...
void movie::playing()
{
    ...
    setdimension("3D");
        ...
        cout<<"\t\t\t________________________________"<<endl;
        cout<<"\n\t\t\tSELECTED MOVIE IS : "<<endl;
        cout<<"________________________________"<<endl;
        cout<<"Movie Title     : "<<m[0].getmoviename()<<endl;
        cout<<"Release Date    : "<<m[0].getrelease()<<endl;
        cout<<"Runtime         : "<<m[0].getruntime()<<endl;
        cout<<"Directed by     : "<<m[0].getdirect()<<endl;
        cout<<"Genre           : "<<m[0].gettype()<<endl;
